...
urlpatterns += patterns('',
    ...
    url(r'^api/place-recent-items/$', views.ajax_place_newsitems, name='ajax-place-newsitems'),
    ...
    url(r'^api/newsitems.geojson/$', views.newsitems_geojson, name='newsitems-geojson'),
