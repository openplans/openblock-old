...
urlpatterns = patterns(
    ...
    url(r'admin/raw_items/(?P<slug>[-_a-z0-9]{1,32})\/?$', views.ajax_widget_raw_items, name="ajax_widget_raw_items"),
    url(r'admin/pins/(?P<slug>[-_a-z0-9]{1,32})\/?$', views.ajax_widget_pins, name="ajax_widget_pins"),
